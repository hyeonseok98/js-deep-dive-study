...
* 이를 통해 코드의 오류를 더 쉽게 발견할 수 있고, 예기치 않은 동작을 방지할 수 있습니다. 
* 자바스크립트의 기존 느슨한 문법을 더 엄격하게 해석함으로써, 개발자가 더 안전하고 성능이 좋은 코드를 작성할 수 있도록 돕습니다.
* Strict mode를 활성화하려면 스크립트 파일의 맨 위나 함수의 맨 위에 "use strict";라는 지시어를 추가하면 됩니다. 다음은 두 가지 예시입니다.
